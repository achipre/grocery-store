  ...
  return (
    <section className="mt-5">
      ...
      {categoryList.map(category => (
        <Link href={'/products-category/'+category?.attributes?.name} className="h-full flex flex-col bg-stone-300 p-8 rounded-xl cursor-pointer group hover:bg-stone-400 transition-all ease-in-out" key={category.id}>
